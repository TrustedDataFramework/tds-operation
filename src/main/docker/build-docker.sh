...
_arg_image="registry.cn-hangzhou.aliyuncs.com/tdf_hangzhou/tds_monitor"
_arg_push="off"
...
print_help()
{
	...
	printf '\t%s\n' "-i, --image: image name (default: 'registry.cn-hangzhou.aliyuncs.com/tdf_hangzhou/tds_monitor')"
...
cp $PROJECT_ROOT/build/libs/monitor.jar $CUR/build
