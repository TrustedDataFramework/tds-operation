...
public class ByteUtil {
     ...
     * @return
     */
    public static boolean paritybyteempty(byte[] a){
        int b=0;
    ...
    public static boolean checkZero(byte[] b){
     ...
     * @return
     */
    public static byte[] bytearraycopy(byte[] s,int start,int count){
     ...
     * @return
     */
    public static int bytesInt(byte[] b){
        int len = 1;
        int n = ((int)b[0]) & 0xff;
        n <<= (--len) * 8;
        return n;
